(function(){const c=document.createElement("link").relList;if(c&&c.supports&&c.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))l(n);new MutationObserver(n=>{for(const i of n)if(i.type==="childList")for(const u of i.addedNodes)u.tagName==="LINK"&&u.rel==="modulepreload"&&l(u)}).observe(document,{childList:!0,subtree:!0});function v(n){const i={};return n.integrity&&(i.integrity=n.integrity),n.referrerPolicy&&(i.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?i.credentials="include":n.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function l(n){if(n.ep)return;n.ep=!0;const i=v(n);fetch(n.href,i)}})();window.addEventListener("DOMContentLoaded",()=>{const f=document.querySelectorAll(".tabheader__item"),c=document.querySelectorAll(".tabcontent"),v=document.querySelector(".tabheader__items");function l(){c.forEach(e=>{e.classList.add("hide"),e.classList.remove("show","fade")}),f.forEach(e=>{e.classList.remove("tabheader__item_active")})}function n(e=0){c[e].classList.add("show","fade"),c[e].classList.remove("hide"),f[e].classList.add("tabheader__item_active")}l(),n(),v.addEventListener("click",e=>{const s=e.target;s&&s.classList.contains("tabheader__item")&&f.forEach((t,a)=>{s==t&&(l(),n(a))})});const i="2026-04-15";function u(e){let s,t,a,r;const o=Date.parse(e)-new Date;return o<=0?(s=0,t=0,a=0,r=0):(s=Math.floor(o/(1e3*60*60*24)),t=Math.floor(o/(1e3*60*60)%24),a=Math.floor(o/1e3/60%60),r=Math.floor(o/1e3%60)),{total:o,days:s,hours:t,minutes:a,seconds:r}}function p(e){return e>=0&&e<10?`0${e}`:e}function T(e,s){const t=document.querySelector(e),a=t.querySelector("#days"),r=t.querySelector("#hours"),o=t.querySelector("#minutes"),m=t.querySelector("#seconds"),w=setInterval(M,1e3);M();function M(){const h=u(s);a.innerHTML=p(h.days),r.innerHTML=p(h.hours),o.innerHTML=p(h.minutes),m.innerHTML=p(h.seconds),h.total<=0&&clearInterval(w)}}T(".timer",i);const S=document.querySelectorAll("[data-modal]"),d=document.querySelector(".modal");S.forEach(e=>{e.addEventListener("click",g)});function g(){d.classList.add("show"),d.classList.remove("hide"),document.body.style.overflow="hidden",clearInterval(q)}function y(){d.classList.add("hide"),d.classList.remove("show"),document.body.style.overflow=""}d.addEventListener("click",e=>{(e.target===d||e.target.getAttribute("data-close")=="")&&y()}),document.addEventListener("keydown",e=>{e.code==="Escape"&&d.classList.contains("show")&&y()});const q=setTimeout(g,5e4);function b(){window.pageYOffset+document.documentElement.clientHeight>=document.documentElement.scrollHeight-1&&(g(),window.removeEventListener("scroll",b))}window.addEventListener("scroll",b);class L{constructor(s,t,a,r,o,m,...w){this.src=s,this.alt=t,this.title=a,this.descr=r,this.price=o,this.classes=w,this.parent=document.querySelector(m),this.transfer=3.65,this.changeToPLN()}changeToPLN(){this.price=this.price*this.transfer}render(){const s=document.createElement("div");this.classes.length===0?(this.element="menu__item",s.classList.add(this.element)):this.classes.forEach(t=>s.classList.add(t)),s.innerHTML=`
    ...
    `,document.querySelector(".modal").append(t),setTimeout(()=>{t.remove(),s.classList.add("show"),s.classList.remove("hide"),y()},4e3)}});
